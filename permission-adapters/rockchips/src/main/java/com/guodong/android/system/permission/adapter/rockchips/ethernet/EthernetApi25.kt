 ...
 *
 * https://cs.android.com/android/platform/superproject/+/android-7.1.2_r39:frameworks/base/core/java/android/net/IEthernetManager.aidl
 */
internal object EthernetApi25 : IEthernet {

    private const val TAG = "EthernetApi25"
    ...
    private fun IEthernetManager.setConfiguration(config: Any /* IpConfiguration */) {
        ...
        val clazz = this.javaClass
        val setConfiguration = clazz.getDeclaredMethod("setConfiguration", ipConfigurationClazz)
        setConfiguration.isAccessible = true
        setConfiguration.invoke(this, config)
    }
    ...
    private fun IEthernetManager.getConfiguration(): Any? {
        return try {
            val clazz = this.javaClass
            val getConfiguration = clazz.getDeclaredMethod("getConfiguration")
            getConfiguration.isAccessible = true
            getConfiguration.invoke(this)
        } catch (e: Exception) {
